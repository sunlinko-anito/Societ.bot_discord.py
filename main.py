...
# [แก้ไขจุดที่ 1] สร้างฟังก์ชันหลักในการรันโปรแกรม เพื่อแก้ปัญหาระบบหลับหรือขึ้น Offline
async def main():
    # เรียกเปิดเว็บเซิร์ฟเวอร์ Flask ไว้ล่วงหน้า
    keep_alive()

    # สั่งให้บอทเริ่มการเชื่อมต่อเข้าเซิร์ฟเวอร์ Discord แบบ Asynchronous
    async with bot:
